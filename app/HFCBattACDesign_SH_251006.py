...
class FuelCellSizing:
    def __init__(self):
        ...
        # self.mtom_a = 8600
        # self.mtom_b = 0
        self.n_stacks_series = 2
        self.n_stacks_parallel = 4
        self.volt_req = 800  # voltage to be produced by a fuel cell system
        self.h_cr = 4000
        self.mach_cr = 0.4
        self.oversizing = 0.3
        self.beta = 1.35
        ...
        self.P_W_climb = 10. #14.89 #15.97  # Power to Weight case1(climb),2(cruise),3(descent)
        self.P_W_cruise = 8.6 #10.53
        self.P_W_takeoff = 11.5 #8.6
    ...
    def cal_Ptotal_cruise(self, MTOM_trial, PFC2=5000000):
        ...
        while True:
            ...
            pemfcsys_sizing_results_cruise = FuelCellSystem.size_system(power_fc_sys_parallel, self.volt_req, self.h_cr, self.mach_cr, self.oversizing, self.beta, comp_bool, self.n_stacks_series)
    ...
    def cal_Ptotal_takeoff(self, MTOM_trial, PFC4=500000):
        ...
        while True:
            ...
            pemfcsys_sizing_results_takeoff = FuelCellSystem.size_system(power_fc_sys_parallel, self.volt_req, self.h_cr, self.mach_cr, self.oversizing, self.beta, comp_bool, self.n_stacks_series)
...
class FuelCellSystem:
    ...
    def size_system(power_fc_sys, volt_req, h_cr, mach_cr, oversizing, beta, comp_bool, n_stacks_series):
        ...
        :param self.volt_req: Voltage to be delivered by the fuel cell system (in V)
        :param h_cr: Cruise altitude in m
        :param self.mach_cr: Cruise Mach number
        ...
        # print(mdot_h2)
        # print(f"Stack(1/{self.n_stack_parallel}): {m_stacks:,.0f} kg, Compressor: {m_comp:,.0f} kg, Humidifier: {m_humid:,.0f} kg, HX: {m_hx:,.0f} kg")
