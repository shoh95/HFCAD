...
class FuelCellSizing:
    ...
    def cal_Ptotal_climb(self, PFC1):
        ...
        while True:
            ...
            self.Pcomp1 = pemfcsys_sizing_results_climb['power_comp']
    ...
    def cal_Ptotal_cruise(self, PFC2):
        ...
        while True:
            ...
            power_fc_sys_parallel = self.Pfuelcell_cruise/self.n_stacks_parallel         # + self.Pheat_rejected1 + self.Pcooling_system1_fc
            comp_bool = 1
            ...
            self.mdot_cruise = pemfcsys_sizing_results_cruise['mdot_h2']

            self.Pcomp2 = pemfcsys_sizing_results_cruise['power_comp']
    ...
    def cal_Ptotal_takeoff(self, PFC4):
        ...
        while True:
            ...
            power_fc_sys_parallel = Pfuelcell_takeoff/self.n_stacks_parallel         # + self.Pheat_rejected1 + self.Pcooling_system1_fc
            comp_bool = 1
            ...
            Pcomp4 = pemfcsys_sizing_results_takeoff['power_comp']
    ...
    def cal_MTOM(self):
        ...
        self.mFC = self.n_stacks_parallel * (pemfcsys_sizing_results['m_stacks'] + pemfcsys_sizing_results['m_humid'] + pemfcsys_sizing_results['m_comp'])
        ...
        self.mfuel = self.n_stacks_parallel*self.mdot_cruise*self.Rtotal/pemfcsys_sizing_results['v_cr']
